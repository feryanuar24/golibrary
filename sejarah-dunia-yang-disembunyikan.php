...
if(!isset($_SESSION['login'])) {
    ...
    if(isset($_POST['sejarah-dunia-yang-disembunyikan'])) {
        $nama = $_POST['nama'];
        $komentar = $_POST['komentar'];
        $tanggal = $_POST['tanggal'];
        $sql = "INSERT INTO sejarah VALUES (null,'$nama','$komentar','$tanggal')";
...
<body>
    ...
    <section class="container my-5">
        ...
        <?php
        $sql = "SELECT * FROM sejarah ORDER BY id DESC";
        $result = mysqli_query($conn, $sql); 
    ...
    <section class="container">
        <div class="row mb-5">
            <div class="col-md-8">
            <form href="sejarah-dunia-yang-disembunyikan.php" method="post">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary" name="sejarah-dunia-yang-disembunyikan">Posting Review</button>
            </form>
            </div>
            <div class="col-md-1">
            </div>
