...
<html lang="id">
  ...
  <body>
    ...
    <section class="float-start bg-light p-5">
      <div class="container">
        <div><h2>GoLibrary</h2></div>
        <div class="mb-3">
          <p class="text-muted">
            Sebuah website yang dirancang untuk membantu pengunjung <br>
            dalam memantau data buku yang tersedia di perpustakaan A.
          </p>
        </div>
        <div class="py-5">
          <img
            src="img/login.png"
            alt="Ilustrasi Perustakaan"
            width="500"
            class="img-fluid"
          />
        </div>
