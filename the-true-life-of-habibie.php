...
if(!isset($_SESSION['login'])) {
    ...
    if(isset($_POST['the-true-life-of-habibie'])) {
        $nama = $_POST['nama'];
        $komentar = $_POST['komentar'];
        $tanggal = $_POST['tanggal'];
        $sql = "INSERT INTO habibie VALUES (null,'$nama','$komentar','$tanggal')";
...
<body>
    ...
    <section class="container my-5">
        ...
        <?php
        $sql = "SELECT * FROM habibie ORDER BY id DESC";
        $result = mysqli_query($conn, $sql); 
    ...
    <section class="container">
        <div class="row mb-5">
            <div class="col-md-8">
            <form href="the-true-life-of-habibie.php" method="post">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary" name="the-true-life-of-habibie">Posting Review</button>
            </form>
            </div>
            <div class="col-md-1">
            </div>
