...
if(!isset($_SESSION['login'])) {
    ...
    if(isset($_POST['reason-to-stay-alive'])) {
        $nama = $_POST['nama'];
        $komentar = $_POST['komentar'];
        $tanggal = $_POST['tanggal'];
        $sql = "INSERT INTO reason VALUES (null,'$nama','$komentar','$tanggal')";
...
<body>
    ...
    <section class="container">
        <div class="row mb-5">
            <div class="col-md-8">
            <form href="reason-to-stay-alive.php" method="post">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary" name="reason-to-stay-alive">Posting Review</button>
            </form>
            </div>
            <div class="col-md-1">
            </div>
